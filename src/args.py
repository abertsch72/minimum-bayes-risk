...
class Args:
    ...
    class PipelineArgs:
        ...
        save_directory: str = field(default="full-test-outputs")
    ...
    class DatasetArgs:
        class SupportedDataset(Enum):
            ...
            aqua = ['json', {
                "test": "data/aqua-test.jsonl",
                "dev": "data/aqua-dev.jsonl"
            }]
            gsm8k = ['gsm8k', 'main']
    ...
    class ListRerankArgs:
        ...
        length_corrected: Optional[str] = field(
            default=None,
        ...
        length_penalty: Optional[float] = field(
            default=1.0,
            metadata={"help": "Length penalty hyperparameter for various length correction strategies"}
        )
