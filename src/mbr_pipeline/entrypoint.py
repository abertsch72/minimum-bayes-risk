...
from list_gen.sample import SamplingMethods, sample
...
sampling_outputs = sample(strategy_fn=strategy_fn, model=model, tokenizer=tokenizer, dataset=dataset, strategy_args=args.gen.method_args.__dict__)
