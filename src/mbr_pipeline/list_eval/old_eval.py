...
class Metrics:
    ...
    def __init__(self):
        ...
        self.metrics = {
            "unique_summaries": [],
            "top1_rouge": self.RougeList(),
            "bottom1_rouge": self.RougeList(),
            "selfbleu": [],
            "avg_score": self.RougeList(),
            "correlation": [],
        }
    ...
    def eval(self, item):
        ...
        for opt in unique:
            ...
            for metric in self.rerank_metrics:
                weighted_scores[metric] = weighted_scores.get(metric, 0) + score[
                    metric
                ].fmeasure * options.count(opt)
