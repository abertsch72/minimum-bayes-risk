...
results_dir = "output/output/text/sum_xsum_bs_16_35_False_0.4_False_False_4_5_zip_-1_0.0_0.9"
...
print(f"random rouge-1: mean = {np.mean(random_r1_scores)}, stddev = {np.std(random_r1_scores)}")
print(f"random rouge-2: mean = {np.mean(random_r2_scores)}, stddev = {np.std(random_r2_scores)}")
print(f"random rouge-l: mean = {np.mean(random_rl_scores)}, stddev = {np.std(random_rl_scores)}")
