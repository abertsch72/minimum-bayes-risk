...
PYTHONPATH=./ python src/recom_search/scripts/run_pipeline.py -nexample 5000  -ngram_suffix 4 -beam_size 16 -min_len 10 -max_len 35 -model bfs_recom -merge rcb  -avg_score 0.75  -dfs_expand -device cuda:0 -startexample 10000
